    ...
    <asp:Table CellPadding="4" runat="server" BackColor="Transparent" BorderColor="Transparent" BorderWidth="10" width="100%">
        ...
        <asp:TableRow>
         ...
         <asp:TableRow>
            ...
            <asp:TableCell><asp:RequiredFieldValidator CssClass="small" runat="server" ControlToValidate="salePrice" ErrorMessage="Required field" ForeColor="Red"/></asp:TableCell>
        </asp:TableRow>
