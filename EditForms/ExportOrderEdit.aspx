<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="ExportOrderEdit.aspx.cs" Inherits="DB_ex1.EditForms.ExportOrderEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <asp:Table ID="exportInfo" CellPadding="4" runat="server" BackColor="Transparent" BorderColor="Transparent" BorderWidth="10" width="100%">
        ...
        <asp:TableRow>
            ...
            <asp:TableCell><asp:RequiredFieldValidator CssClass="small" runat="server" ValidationGroup="info" ControlToValidate="updateBy" ErrorMessage="Required field" ForeColor="Red"/></asp:TableCell>
        </asp:TableRow>
    </asp:Table>
