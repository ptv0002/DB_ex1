...
namespace DB_ex1.EditForms
{
    public partial class ExportOrderEdit : System.Web.UI.Page
    {
        ...
        static List<Export_Goods> listGoods;
        static List<Export_Info> listInfo;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                person = listModel.ListCustomer(listInfo.ElementAt(0).CustomerId);
                BindInfo();
        ...
        public void UpdateInfo()
        {
            ...
            bool card = Convert.ToBoolean(ddCard.SelectedValue);
            double percent = 1;
