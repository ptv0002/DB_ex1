<%@ Page Title="" Language="C#" MasterPageFile="~/Empty.Master" AutoEventWireup="true" CodeBehind="ImportOrderAdd.aspx.cs" Inherits="DB_ex1.AddForms.ImportOrderAdd" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <asp:GridView style="height:50px;overflow:auto" HeaderStyle-CssClass="FixedHeader" FooterStyle-CssClass="FixedHeader" CellPadding="4" runat="server" ID="gv" AutoGenerateColumns="False" AllowPaging= "True" ForeColor= "#333333"  Width= "100%" OnRowEditing="OnRowEditing" ShowFooter="True" OnRowDeleting="OnRowDeleting" GridLines="Both">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Good's name">
                ...
                <ItemTemplate>
                    <asp:Label ID="label3" runat="server" Text='<%# Bind("GoodsName") %>'/>
                </ItemTemplate>
                <FooterTemplate>
            ...
            <asp:TemplateField HeaderText="Price">
                ...
                <ItemTemplate>
                    <asp:Label ID="label1" runat="server" Text='<%# Bind("Price") %>'/>
                </ItemTemplate>
                <FooterTemplate>
    ...
    <asp:Table runat="server" GridLines="Both" Width="100%" CellPadding="4" ID="emptyTable">
        ...
        <asp:TableRow BackColor="#26a69a"  ForeColor= "#333333"  Width= "100%" >
            ...
            <asp:TableCell>
                ...
                <asp:RequiredFieldValidator CssClass="small" runat="server" ValidationGroup="info" ControlToValidate="priceEmpty" ErrorMessage="Required field" ForeColor="Red"/>
            </asp:TableCell>
            <asp:TableCell>
                <asp:TextBox ID="discountEmpty" runat="server"  Width="100%"/>
                <asp:RequiredFieldValidator CssClass="small" runat="server" ValidationGroup="info" ControlToValidate="discountEmpty" ErrorMessage="Required field" ForeColor="Red"/>
            </asp:TableCell>
            <asp:TableCell></asp:TableCell>
        </asp:TableRow>
    </asp:Table>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <asp:Button class= "btn btn-danger" Text="Delete" onClick="btnDelete_Click" runat="server" />
